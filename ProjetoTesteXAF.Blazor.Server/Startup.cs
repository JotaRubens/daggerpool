...
using ProjetoTesteXAF.Blazor.Server.Services;
...
using ProjetoTesteXAF.WebApi.JWT;
using DevExpress.ExpressApp.Security.Authentication;
using DevExpress.ExpressApp.Security.Authentication.ClientServer;

namespace ProjetoTesteXAF.Blazor.Server;
...
public class Startup {
    ...
    public void ConfigureServices(IServiceCollection services) {
        ...
        services.AddXaf(Configuration, builder => {
            builder.UseApplication<ProjetoTesteXAFBlazorApplication>();
            ...
            builder.Modules
                ...
                .AddViewVariants()
                .Add<ProjetoTesteXAF.Module.ProjetoTesteXAFModule>()
            	.Add<ProjetoTesteXAFBlazorModule>();
            builder.ObjectSpaceProviders
                .AddSecuredEFCore(options => options.PreFetchReferenceProperties())
                    .WithDbContext<ProjetoTesteXAF.Module.BusinessObjects.ProjetoTesteXAFEFCoreDbContext>((serviceProvider, options) => {
            ...
            builder.Security
                .UseIntegratedMode(options => {
                    ...
                    options.UserType = typeof(ProjetoTesteXAF.Module.BusinessObjects.ApplicationUser);
                    // ApplicationUserLoginInfo is only necessary for applications that use the ApplicationUser user type.
                    // If you use PermissionPolicyUser or a custom user type, comment out the following line:
                    options.UserLoginInfoType = typeof(ProjetoTesteXAF.Module.BusinessObjects.ApplicationUserLoginInfo);
        ...
        services.AddSwaggerGen(c => {
            ...
            c.SwaggerDoc("v1", new OpenApiInfo {
                Title = "ProjetoTesteXAF API",
                Version = "v1",
                Description = @"Use AddXafWebApi(options) in the ProjetoTesteXAF.Blazor.Server\Startup.cs file to make Business Objects available in the Web API."
            });
    ...
    public void Configure(IApplicationBuilder app, IWebHostEnvironment env) {
        if(env.IsDevelopment()) {
            ...
            app.UseSwagger();
            app.UseSwaggerUI(c => {
                c.SwaggerEndpoint("/swagger/v1/swagger.json", "ProjetoTesteXAF WebApi v1");
            });
        }
        else {
