...
namespace ProjetoTesteXAF.Module;

// For more typical usage scenarios, be sure to check out https://docs.devexpress.com/eXpressAppFramework/DevExpress.ExpressApp.ModuleBase.
public sealed class ProjetoTesteXAFModule : ModuleBase {
    public ProjetoTesteXAFModule() {
		// 
		// ProjetoTesteXAFModule
		// 
		AdditionalExportedTypes.Add(typeof(ProjetoTesteXAF.Module.BusinessObjects.ApplicationUser));
